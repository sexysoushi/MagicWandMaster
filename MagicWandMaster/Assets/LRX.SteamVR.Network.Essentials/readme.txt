...
Hint: You can disable "Virtual Reality Supported" in "Player settings.." -> "Other Settings" -> "Rendering" and then start the project with FPS controls and without the need for VR HMD. This is useful for testing, debugging and asynchronous gameplay mechanics.ü.
...
The last step is to make sure the items are usable. We brushed a bit over the architecture and used our IUsable interface for the GunItem.
